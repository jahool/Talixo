...
public class OrderPage {
    ...
    public void clickDiscountsButton() {
        WebElement discountsButton = driver.findElement(By.xpath("//*[@id=\"passengerForm\"]/div[8]/ul/li[1]/label/span"));
        discountsButton.click();
    }
    public void clickDataProtectionButton() {
        WebElement dataButton = driver.findElement(By.xpath("//*[@id=\"passengerForm\"]/div[8]/ul/li[2]/label/span"));
        dataButton.click();
    }
    public void clickGeneralTermsButton() {
        WebElement termsButton = driver.findElement(By.xpath("//*[@id=\"passengerForm\"]/div[8]/ul/li[3]/label/span"));
        termsButton.click();
    }
